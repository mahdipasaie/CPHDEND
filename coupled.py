...
# mesh_ns = refine_mesh_ranage(coarse_mesh_init, max_y, 5*dy , level_ns)
...
# Usage Example:
file_ns = fe.XDMFFile( "NS.xdmf" )
file_pf = fe.XDMFFile( "PF.xdmf" )
...
for it in  range(0, 10000000) :
    ...
    if it % 100 == 0: 
        ...
        write_simulation_data_to_files(solution_vectors, T, file_ns, file_pf, variable_names_list_ns, variable_names_list_pf, extra_funcs_dict_ns, extra_funcs_dict_pf)
        if rank == 0:
            print("Time: ", T, "Iterations: ", it, flush=True)
